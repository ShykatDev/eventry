...
const BannerCTA = () => {
  return (
    <Section className="p-0 bg-border/30">
      <div className="py-32">
        <div className="border-y relative bg-background flex flex-col sm:flex-row sm:items-stretch">
          <div className="sm:w-3/5">
            <div className="h-4 border-r" />
            <div className="pt-4 border-t border-r">
              <p className="text-4xl sm:text-7xl md:text-9xl text-border px-4">
